...
let ShiftExchangeModule = class ShiftExchangeModule {
};
ShiftExchangeModule = __decorate([
    NgModule({
        imports: [
            // FIXME: Something with providedIn: 'root' is broken
...
export { ShiftExchangeModule };
//# sourceMappingURL=shift-exchange.module.js.map