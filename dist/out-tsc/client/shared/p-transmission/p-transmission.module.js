...
let PTransmissionModule = class PTransmissionModule {
};
PTransmissionModule = __decorate([
    NgModule({
        imports: [
...
export { PTransmissionModule };
//# sourceMappingURL=p-transmission.module.js.map