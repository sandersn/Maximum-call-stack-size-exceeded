...
let PShiftExchangeModule = class PShiftExchangeModule {
};
PShiftExchangeModule = __decorate([
    NgModule({
        imports: [
            ClientPipesModule,
...
export { PShiftExchangeModule };
//# sourceMappingURL=p-shift-exchange.module.js.map