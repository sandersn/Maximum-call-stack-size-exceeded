...
describe('#HighlightService', () => {
    ...
    it('should have a defined instance', () => {
        ...
        expect(firstShiftModel).toBeDefined();
        assumeNonNull(firstShiftModel);
    ...
    describe('isMuted()', () => {
        ...
        it('unrelated shiftModel should be muted, when shift is selected', () => {
            ...
            expect(secondShiftModel).toBeDefined();
            assumeNonNull(secondShiftModel);
            expect(service.isMuted(secondShiftModel)).toBe(true);
        });
    });
});
//# sourceMappingURL=highlight.service.spec.js.map