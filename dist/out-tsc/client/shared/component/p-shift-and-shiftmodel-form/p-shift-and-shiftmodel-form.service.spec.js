...
describe('PShiftAndShiftmodelFormService #needsapi', () => {
    ...
    describe('initFormGroup()', () => {
        ...
        beforeAll((done) => {
            ...
            spyOnProperty(formItem, 'neededMembersCountConf').and.returnValue(new SchedulingApiShiftNeededMembersCountConf(fakeApi));
...
//# sourceMappingURL=p-shift-and-shiftmodel-form.service.spec.js.map