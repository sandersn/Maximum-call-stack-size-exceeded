...
let ClientSharedComponentsModule = class ClientSharedComponentsModule {
};
ClientSharedComponentsModule = __decorate([
    NgModule({
        imports: [
            ClientPipesModule,
            CoreModule,
...
export { ClientSharedComponentsModule };
//# sourceMappingURL=client-shared-components.module.js.map