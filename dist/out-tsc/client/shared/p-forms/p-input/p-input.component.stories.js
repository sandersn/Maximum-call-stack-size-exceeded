...
for (const type of Object.values(PApiPrimitiveTypes)) {
    if (type === PApiPrimitiveTypes.Date)
        continue;
    if (type === PApiPrimitiveTypes.ShiftId)
        continue;
    if (type === PApiPrimitiveTypes.any)
        continue;
    if (type === PApiPrimitiveTypes.DateTime)
        continue;
    if (type === PApiPrimitiveTypes.Id)
        continue;
    if (type === PApiPrimitiveTypes.Enum)
        continue;
    if (type === PApiPrimitiveTypes.boolean)
        continue;
    if (type === PApiPrimitiveTypes.DateExclusiveEnd)
        continue;
    if (type === PApiPrimitiveTypes.ApiList)
        continue;
    if (type === PApiPrimitiveTypes.Image)
        continue;
    allTypesTemplate += `
...
const getTypeTemplate = (type, locale, placeholder, durationUIType) => `
		<p-input
			type="${type}"
			locale="${locale !== null && locale !== void 0 ? locale : ''}"
			durationUIType="${durationUIType !== null && durationUIType !== void 0 ? durationUIType : ''}"
    ...
    switch (enumValue) {
        case PApiPrimitiveTypes.Currency:
            myStory.add(`type="${PApiPrimitiveTypes.Currency}"`, () => ({
                ...
                props: {
                    ...
                    getCurrencyCode: (locale) => Config.getCurrencyCode(locale),
            ...
            myStory.add(`type="${PApiPrimitiveTypes.Days}"`, () => ({
                ...
                props: {
                    ...
                    formControl: new PFormControl({
                        ...
                        ].concat(new PFormControl(undefined).getValidatorsForPrimitiveType(PApiPrimitiveTypes.Days)),
                    }),
                    blur: action('blur'),
        ...
        case PApiPrimitiveTypes.LocalTime:
            myStory.add(`type="${PApiPrimitiveTypes.LocalTime}"`, () => ({
                template: getTypeTemplate(PApiPrimitiveTypes.LocalTime, PSupportedLocaleIds.de_DE) +
...
//# sourceMappingURL=p-input.component.stories.js.map