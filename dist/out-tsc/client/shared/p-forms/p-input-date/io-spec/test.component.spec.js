...
describe('#PFormsModule#PInputDateComponent#IO', () => {
    ...
    // 	});
    // };
    const addDeadlineTest = (locale, max, ngModel, value) => {
        describe(locale, () => {
    ...
    describe('type deadline', () => {
        addDeadlineTest(PSupportedLocaleIds.de_DE, 1586415600000, // Apr 09 2020 09:00:00 GMT+0200 (Central European Summer Time)
        1586210400000, // Apr 07 2020 00:00:00 GMT+0200 (Central European Summer Time)
        '3');
        addDeadlineTest(PSupportedLocaleIds.de_DE, 1586383200000, // Apr 09 2020 00:00:00 GMT+0200 (Central European Summer Time)
        1586210400000, // Apr 07 2020 00:00:00 GMT+0200 (Central European Summer Time)
        '3');
        addDeadlineTest(PSupportedLocaleIds.en_GB, 1586419200000, // Apr 09 2020 09:00:00 GMT+0100
