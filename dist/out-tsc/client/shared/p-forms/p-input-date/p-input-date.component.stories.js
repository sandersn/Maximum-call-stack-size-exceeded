...
const getTemplate = (type, _isExclusiveEnd) => `
...
export class FakeConfig {
    constructor() {
        this.LOCALE_ID = PSupportedLocaleIds.de_DE;
        this.TIME_ZONE = PSupportedTimeZones.EUROPE_BERLIN;
...
//# sourceMappingURL=p-input-date.component.stories.js.map