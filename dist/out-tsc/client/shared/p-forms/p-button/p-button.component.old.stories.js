...
const getAllButtonTemplates = () => {
    ...
    for (const type of Object.values(PThemeEnum))
        allButtons += getTemplate(type);
    for (const type of Object.values(PBtnThemeEnum))
        allButtons += getTemplate(type);
    allButtons += `
		<div class="">
...
//# sourceMappingURL=p-button.component.old.stories.js.map