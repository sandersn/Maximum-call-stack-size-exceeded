...
myStory
    ...
    props: {
        ...
        getFormControlForShiftModel: (shiftModelId) => {
            return formArray.controls.find((control) => control.get('id').value.equals(shiftModelId));
        },
...
//# sourceMappingURL=shiftmodel-list.component.stories.js.map