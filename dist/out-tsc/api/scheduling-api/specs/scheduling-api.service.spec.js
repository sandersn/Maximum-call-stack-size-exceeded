...
import { SchedulingApiBookingDesiredDateSetting, } from './../scheduling-api.service.ag';
import { SchedulingApiShiftRepetitionType, SchedulingApiAssignmentProcessState, SchedulingApiWorkingTimeCreationMethod, SchedulingApiAssignmentProcessType, SchedulingApiGender, SchedulingApiRightGroupRole, } from './../scheduling-api.service.ag';
...
describe('#SchedulingApiService #needsapi', () => {
    ...
    // //// GENERAL /////////////////////////////////////////////////////////////////////////////////
    // //////////////////////////////////////////////////////////////////////////////////////////////
    const createOrModifyShiftModel = (shiftModel) => {
    ...
    describe('general', () => {
        ...
        describe('general-api-tests', () => {
            ...
            it('new-item-is-added-once', (done) => {
            ...
            it('new-created-item-has-db-id', (done) => {
            ...
            it('new-item-wrapper-is-not-lost-when-calling-load-after-item-creation', (done) => {
            ...
            it('consecutive-save-call-changes-are-not-shadowed', (done) => {
    ...
    describe('calendar', () => {
        ...
        it('ensureShifts-query-param', (done) => {
            api.load({
                success: () => {
                    const shiftId = api.data.shifts.get(0).id;
                    const queryParams = new HttpParams()
                        .set('ensureShifts', JSON.stringify([shiftId], (_key, value) => (value instanceof ShiftId ? value.rawData : value)));
                    api.load({
                        success: () => {
        ...
        /** ***********************************************************************************/
        describe('members', () => {
            let newMemberAssignableShiftModelId = undefined;
            ...
            apiTestingUtils.doDefaultListTests({
                ...
                removeMethod: 'none',
                beforeRawDataCompare: (member, rawDataBeforeSave) => {
        ...
        describe('shifts', () => {
            ...
            apiTestingUtils.doDefaultListTests({
                ...
                createNewItem: () => {
                    return api.data.shifts.createNewShift(api.data.shiftModels.get(0), pMoment.m().startOf('day'), getApiQueryParams('calendar'));
                }
            });
            it('apply-changes-to-shift-model', (done) => {
        ...
        describe('#assignment-processes', () => {
            let assignmentProcess = null;
            const testCreateProcess = (type) => {
            ...
            const testReopenAskMemberPrefState = () => {
    ...
    describe('reporting', () => {
        ...
        describe('working-times', () => {
            apiTestingUtils.doDefaultListTests({
                ...
                beforeRawDataCompare: (workingTime, rawDataBeforeSave) => {
    ...
    describe('#automatic-working-time-creation', () => {
        ...
        /** ***********************************************************************************/
        it('on-series-creation-for-past', (done) => {
            const cleanUp = (shiftId) => {
                api.load({
                    success: () => {
            ...
            for (const shiftModel of api.data.shiftModels.iterable()) {
                ...
                if (shiftModel.name === 'Yoga') {
                    ...
                    api.data.shifts.createNewShift(shiftModel, pMoment.m().subtract(1, 'weeks'), getApiQueryParams('calendar'), (newShift) => {
        ...
        /** ***********************************************************************************/
        it('on-working-time-creation-method-change-for-past', (done) => {
...
//# sourceMappingURL=scheduling-api.service.spec.js.map