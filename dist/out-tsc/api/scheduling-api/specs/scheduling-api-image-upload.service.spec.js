...
describe('#SchedulingApiService #needsapi', () => {
    ...
    describe('#image-upload', () => {
        ...
        it('add-image', (done) => {
            ...
            api.save({
                success: () => {
                    ...
                    testingUtils.checkFileExists(newImageUrl, (oldFileExists) => {
        ...
        it('change-image', (done) => {
            ...
            api.save({
                success: () => {
                    ...
                    testingUtils.checkFileExists(newImageUrl, (newFileExists) => {
                        expect(newFileExists).toBeTrue();
                        // check old file does NOT exist on S3
                        testingUtils.checkFileExists(oldImageUrl, (exists) => {
        ...
        it('test-automatic-removal-on-client-delete', (done) => {
                                ...
                                success: () => {
                                    ...
                                    clientsApi.save({
                                        success: () => {
                                            ...
                                            testingUtils.checkFileExists(newImageUrl, (exists) => {
                                                expect(exists).toBeFalse();
                                                done();
                                            });
                                        },
...
//# sourceMappingURL=scheduling-api-image-upload.service.spec.js.map