...
let ExportVouchersExcelApiService = class ExportVouchersExcelApiService extends ApiBase {
    constructor(h, router, apiE, zone, injector) {
        super(h, router, apiE, zone, injector, 'export_vouchers_excel');
        this.consts = new Consts();
        this.dataWrapper = new ExportVouchersExcelApiRoot(this);
    }
    version() {
...
ExportVouchersExcelApiService = __decorate([
    Injectable({
        providedIn: 'root',
    }),
...
], ExportVouchersExcelApiService);
export { ExportVouchersExcelApiService };
export class ExportVouchersExcelApiRoot extends ApiObjectWrapper {
    constructor(api, idRaw = null) {
        super(api, ExportVouchersExcelApiRoot);
        this.api = api;
        this._id = null;
        ...
        this.voucherIdsWrapper = new ExportVouchersExcelApiVoucherIds(this.api, false);
...
export class ExportVouchersExcelApiVoucherIds extends ApiListWrapper {
    ...
    wrapItem(item, _generateMissingData) {
        const newWrapper = new ExportVouchersExcelApiVoucherId(this.api);
    ...
    createInstance(removeDestroyedItems) {
        return new ExportVouchersExcelApiVoucherIds(this.api, removeDestroyedItems);
    }
    get dni() {
        return '2';
    }
...
export class ExportVouchersExcelApiVoucherId extends ApiObjectWrapper {
    constructor(api, idRaw = null) {
        super(api, ExportVouchersExcelApiVoucherId);
        this.api = api;
        this.parent = null;
        this._id = null;
        this.attributeInfoThis = new ApiAttributeInfo({
...
//# sourceMappingURL=export-vouchers-excel-api.service.ag.js.map