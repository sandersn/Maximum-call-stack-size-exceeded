...
let ExportBillingDataApiService = class ExportBillingDataApiService extends ApiBase {
    constructor(h, router, apiE, zone, injector) {
        super(h, router, apiE, zone, injector, 'export_billing_data');
        this.consts = new Consts();
        this.dataWrapper = new ExportBillingDataApiRoot(this);
    }
    version() {
...
ExportBillingDataApiService = __decorate([
    Injectable({
        providedIn: 'root',
    }),
...
], ExportBillingDataApiService);
export { ExportBillingDataApiService };
export class ExportBillingDataApiRoot extends ApiObjectWrapper {
    constructor(api, idRaw = null) {
        super(api, ExportBillingDataApiRoot);
        this.api = api;
        this._id = null;
...
//# sourceMappingURL=export-billing-data-api.service.ag.js.map