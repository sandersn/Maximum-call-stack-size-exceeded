...
export class Meta {
     ...
     */
    static createNewObject(atomic, id = null) {
     ...
     */
    static updateNewItemDbIds(dataToUpdate, newData) {
     ...
     */
    static replaceIdByNewItemId(data, saveOldId) {
    ...
    static replaceIdsByNewItemIdsRecursive(data, idReplacements, dontAddToIdReplacementList) {
        // replace id
        const oldId = new CallByRef();
     ...
     */
    static replaceIdsByNewItemIds(data, dontAddToIdReplacementList) {
     ...
     */
    static getReplacedId(oldId, idReplacements) {
        // old id was replaced?
     ...
     */
    static indexOfByNewItemId(array, newItemId) {
        if (newItemId === null)
            return -1;
     ...
     */
    static checkIsSameArrayAndEnsureBackendId(array1, array2) {
        // equal by newItemId?
