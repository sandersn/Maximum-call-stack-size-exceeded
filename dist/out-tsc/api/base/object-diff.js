...
export class ObjectDiff {
     ...
     */
    static diff(orig, curr, onlyPath = null) {
    ...
    static diffObject(orig, curr, onlyPath) {
    ...
    static diffList(orig, curr, onlyPath) {
        let i;
        let j;
        let currElem;
        let origElement;
     ...
     */
    static diffToNormalFormat(data) {
        // Just a primitive
