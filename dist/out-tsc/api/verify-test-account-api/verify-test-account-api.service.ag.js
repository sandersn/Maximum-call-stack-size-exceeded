...
let VerifyTestAccountApiService = class VerifyTestAccountApiService extends ApiBase {
...
VerifyTestAccountApiService = __decorate([
    Injectable({
        providedIn: 'root',
    }),
...
], VerifyTestAccountApiService);
export { VerifyTestAccountApiService };
export class VerifyTestAccountApiRoot extends ApiObjectWrapper {
    constructor(api, idRaw = null) {
        super(api, VerifyTestAccountApiRoot);
        this.api = api;
        this._id = null;
...
//# sourceMappingURL=verify-test-account-api.service.ag.js.map