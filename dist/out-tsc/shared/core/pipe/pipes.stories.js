...
for (const format of Object.values(AngularDatePipeFormat)) {
    if (format === AngularDatePipeFormat.MEDIUM)
        continue;
    if (format === AngularDatePipeFormat.LONG)
        continue;
    if (format === AngularDatePipeFormat.FULL)
        continue;
    if (format === AngularDatePipeFormat.LONG_TIME)
        continue;
    if (format === AngularDatePipeFormat.FULL_TIME)
        continue;
...
//# sourceMappingURL=pipes.stories.js.map