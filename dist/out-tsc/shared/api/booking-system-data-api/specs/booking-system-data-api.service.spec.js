...
describe('BookingSystemDataApiService #needsapi', () => {
    ...
    describe('load', () => {
        ...
        it('by-tempBookableDataId', async () => {
            ...
            const response = (_a = await httpClient.post(`${Config.BACKEND_URL}/temp_bookable_data?token=${token}`, postData, ApiBase.getRequestOptions(null, null)).toPromise()) !== null && _a !== void 0 ? _a : null;
...
//# sourceMappingURL=booking-system-data-api.service.spec.js.map